...
const About: React.FC = () => {
  const achievements = [
    ...
    { icon: Camera, title: 'Visual Excellence', description: '150+ Published Stories' },
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="order-1 md:order-2">
              ...
              <p className="text-lg text-gray-700 mb-6 leading-relaxed">
                ...
                capturing the untold stories that shape our world. From conflict zones to 
                cultural celebrations, my work bridges the gap between distant realities 
                and global audiences.
              </p>
              
              <p className="text-lg text-gray-700 mb-8 leading-relaxed">
                My approach combines traditional photojournalistic techniques with modern 
                digital storytelling, creating immersive narratives that inform, inspire, 
